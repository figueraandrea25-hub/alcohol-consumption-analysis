---
title: "El Consumo de alcohol per cápita y los datos que no se miden"
author:
  - Andrea Figuera
  - Eduardo Espinoza
date: "Abril 2026"
...
aplicar_estilo_tabla(analisis_robustez, "Contraste entre la media y la mediana")
```
...
ggplot(data_plot, aes(x = reorder(Region, Media), y = Media)) +
  geom_errorbar(aes(ymin = LI, ymax = LS), width = 0.2, color = "#E6283E", size = 1) +
  geom_point(size = 3, color = "#820808") +
  coord_flip() +
  labs(
    title = "Inferencia Visual: Consumo de Alcohol por Región",
