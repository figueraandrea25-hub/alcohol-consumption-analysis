...
aplicar_estilo_tabla <- function(df, caption_text) {
  ...
  #estilos segun el formato de salida
  if (is_latex) {
    #para el PDF
    t <- t %>%
      kable_styling(
      ...
      row_spec(0, bold = TRUE, color = "white", background = "#800000") %>%
...
aplicar_estilo_tabla(top_incertidumbre, "Top 20 Países con Mayor Incertidumbre Estadística")
```
