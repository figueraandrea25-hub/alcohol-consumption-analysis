...
\ El gráfico es un diagrama de dispersión (scatter plot) con una línea de regresión lineal que evalúa la consistencia técnica de los datos reportados para objeto del estudio.
 ...
 El gráfico muestra que la variabilidad no es constante. A mayores niveles de consumo, los puntos se alejan más de la línea de regresión, lo que sugiere que estimar el consumo en países con alta ingesta es técnicamente más complejo o propenso a errores de reporte.
  ...
  El R=0.933 valida que el modelo de reporte es consistente: la incertidumbre es una función directa del volumen. Si hubiera puntos muy alejados de esta tendencia (outliers), indicarían errores de medición específicos en esos países./
...
\section{Truncamiento de la Muestra y su Impacto en los Promedios Regionales}
...
En esta seccion se detallan las bases teoricas, metodologicas y computacionales que sustentan el presente analisis. Las fuentes seleccionadas abarcan desde los fundamentos del analisis exploratorio hasta las investigaciones globales sobre el tratamiento de la incertidumbre en salud publica y mercados.

## Bases de Estadistica y Probabilidad

* **Tukey, J. W. (1977).** *Exploratory Data Analysis*. Addison-Wesley. 
    > (Referencia fundamental para el desarrollo del EDA y la visualizacion de datos mediante diagramas de caja y bigotes). [@tukey1977exploratory]
    
* **Huber, P. J. (1981).** *Robust Statistics*. John Wiley & Sons. 
    > (Sustento teorico para el manejo de valores atipicos y la critica a la sensibilidad de la media aritmetica). [@huber1981robust]
    
* **Spiegelhalter, D. (2019).** *The Art of Statistics: Learning from Data*. Pelican Books. 
    > (Obra clave para entender la comunicacion del riesgo y la tirania de los promedios en la toma de decisiones). [@spiegelhalter2019art]

* **Huff, D. (1954).** *How to Lie with Statistics*. W. W. Norton & Company. 
    > (Validacion sobre la manipulacion politica y social de los indicadores estadisticos centrales). [@huff1954how]

## Investigaciones y Casos de Estudio

* **World Health Organization (2018).** *Global status report on alcohol and health 2018*. 
    > (Referencia para el estudio de indicadores transversales y la complejidad de las estimaciones per capita). [@who2018alcohol]

* **GBD 2016 Alcohol Collaborators (2018).** *Alcohol use and burden for 195 countries and territories*. The Lancet. 
    > (Investigacion que ilustra el fenomeno de solapamiento de intervalos de confianza en comparaciones internacionales). [@gbd2018alcohol]

* **Van der Bles, A. M., et al. (2019).** *Communicating uncertainty about facts, numbers and science*. Royal Society Open Science. 
    > (Estudio sobre la importancia tecnica de reportar la variabilidad y el error en los datos publicos). [@vanderbles2019communicating]

## Fundamentos de Computacion y Analisis de Datos

* **Wickham, H., et al. (2019).** *Welcome to the tidyverse*. Journal of Open Source Software. 
    > (Referencia tecnica para el procesamiento de datos bajo el paradigma de programacion funcional en R). [@wickham2019welcome]

* **Wilke, C. O. (2019).** *Fundamentals of Data Visualization*. O'Reilly Media. 
    > (Guia para el diseno de visualizaciones que representen fielmente la densidad de probabilidad y la incertidumbre). [@wilke2019fundamentals]

* **Little, R. J. A., & Rubin, D. B. (2019).** *Statistical analysis with missing data*. John Wiley & Sons. 
    > (Tratamiento avanzado de valores faltantes y el impacto del sesgo de seleccion en bases de datos masivas). [@little2019statistical]