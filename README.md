# Análisis de consumo de alcohol e incertidumbre (Computación 1 - UCV)
...
###### Informe Dinámico con Rmarkdown: [Link Proximamente]
###### Dashboard con Streamlit: [Link Proximamente]

![R](https://img.shields.io/badge/R-blue) ![Python](https://img.shields.io/badge/Python-yellow) ![UCV](https://img.shields.io/badge/UCV-red)
